...
public class Gui extends JFrame {
    ...
    private void createLabel(JLabel labelName, String labelText, GridBagConstraints constraints, JPanel panel, int xCo,
    ...
    private void createInput(JTextField inputName, GridBagConstraints constraints, JPanel panel, int xCo, int yCo,
	    boolean insets) {
    ...
    private void createComboBox(JComboBox<String> boxName, GridBagConstraints constraints, JPanel panel, int xCo,
	    int yCo) {
	constraints.gridx = xCo;
	constraints.gridy = yCo;
