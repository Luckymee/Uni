 ...
 * 
 * Special Note: You do not need to implement any special constructor when you implement this 
 * interface. Check the call that is seen in GamePanel.java: game = new HiringGame();
 * 
 * @author INB370
 * @version 1.0
 */
public interface IHiringGame
{
	 ...
	 */
	IApplicant getNextApplicant() throws HiringException;
	 ...
	 * 
	 * @return Returns true if the accepted applicant has the highest quality score of all
	 ...
	 * not been accepted 
	 */
	IApplicant getBestApplicant() throws HiringException;
}
